...
class Validator
{
    ...
    private $messages = [
        ...
        'maxlength' => 'The :field must be maximum od :satisfier character',
    ...
    private function minlength($field, $value, $satisfier):bool
    {
        return mb_strlen($value) >=$satisfier;
    }

    private function maxlength($field, $value, $satisfier):bool
    {
        return mb_strlen($value) <=$satisfier;
    }

    private function email($field, $value, $satisfier):bool
    {
