...
class Token
{
    ...
    public function createForgotPsswordToken(int $userId):array|null
    {
    ...
    public function createToken(int $userId, int $isRemember):array|null
    {
        ...
        //otherwise generate a new token, save in the db and return the new token
        $currentTime = date('Y-m-d H:i:s');
        $timeToBeAdded = $isRemember ? self::$REMEMBER_EXPIRY_TIME : self::$FORGOT_PWD_EXPIRY_TIME;
